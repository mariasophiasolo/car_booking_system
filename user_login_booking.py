...
class MobileApp:
    def __init__(self, master):
        ...
        self.header_label = tk.Label(self.header_frame, text="Z O O M E R S", font=("Comic Sans MS", 15, "bold", "italic" ), bg="#F6D2E0")
        ...
        self.welcome_label = tk.Label(self.form_frame, text="Hello, ZOOM-IT user!", font=("Candara", 35), bg="#C8E7F5")
