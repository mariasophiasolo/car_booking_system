...
class BookingWindow(tk.Toplevel):
    def __init__(self, master=None, vehicle_type=""):
        ...
        self.title(f"{vehicle_type} Booking")
        self.geometry("500x500")
        self.resizable(False, False)

        font2 = CTkFont(family= "Inter", size=20)

        self.motor_booking_frame = CTkFrame(self, width=449, height=434, fg_color="#72BFEA", border_width=2, border_color="#042D44")
        self.motor_booking_frame.place(relx=0.5, rely=0.5, anchor="center")

         # Pick-up Address
        self.pickup_label = CTkLabel(self.motor_booking_frame, text="Pick-up Address:", font=font2)
        self.pickup_label.place(relx=0.1, rely=0.1, anchor="w")

        self.pickup_entry = CTkEntry(self.motor_booking_frame, width=200, bg_color="#F6D2E0")
        self.pickup_entry.place(relx=0.5, rely=0.1, anchor="w")

        # Drop-off Address
        self.pickup_label = CTkLabel(self.motor_booking_frame, text="Drop-off Address:", font=font2)
        ...
        # Pick-up Time
        self.pickup_label = CTkLabel(self.motor_booking_frame, text="Pick-up Time:", font=font2)
        ...
        # Submit button
        self.submit_button = CTkButton(self.motor_booking_frame, text=" Submit")
